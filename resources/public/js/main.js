var CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=335b42&fwbuild=dev"};
...
document.write('<script>goog.require("email.email");</script>');
