...
garden.types.CSSUnit.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k18657,else__4206__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k18657,else__4206__auto__);
...
garden.types.CSSUnit.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__18656){
var self__ = this;
var G__18656__$1 = this;
return (new cljs.core.RecordIter((0),G__18656__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"unit","unit",375175175),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
garden.types.CSSUnit.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this18658,other18659){
var self__ = this;
var this18658__$1 = this;
return ((!((other18659 == null))) && ((this18658__$1.constructor === other18659.constructor)) && (cljs.core._EQ_.call(null,this18658__$1.unit,other18659.unit)) && (cljs.core._EQ_.call(null,this18658__$1.magnitude,other18659.magnitude)) && (cljs.core._EQ_.call(null,this18658__$1.__extmap,other18659.__extmap)));
});
...
garden.types.CSSUnit.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__18656){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__18662 = cljs.core.keyword_identical_QMARK_;
var expr__18663 = k__4211__auto__;
if(cljs.core.truth_(pred__18662.call(null,new cljs.core.Keyword(null,"unit","unit",375175175),expr__18663))){
return (new garden.types.CSSUnit(G__18656,self__.magnitude,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__18662.call(null,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),expr__18663))){
return (new garden.types.CSSUnit(self__.unit,G__18656,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4211__auto__,G__18656),null));
}
}
});
...
garden.types.CSSUnit.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__18656){
var self__ = this;
var this__4202__auto____$1 = this;
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,G__18656,self__.__extmap,self__.__hash));
});
 ...
 */
garden.types.map__GT_CSSUnit = (function garden$types$map__GT_CSSUnit(G__18660){
var extmap__4236__auto__ = (function (){var G__18667 = cljs.core.dissoc.call(null,G__18660,new cljs.core.Keyword(null,"unit","unit",375175175),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
if(cljs.core.record_QMARK_.call(null,G__18660)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__18667);
} else {
return G__18667;
}
})();
return (new garden.types.CSSUnit(new cljs.core.Keyword(null,"unit","unit",375175175).cljs$core$IFn$_invoke$arity$1(G__18660),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222).cljs$core$IFn$_invoke$arity$1(G__18660),null,cljs.core.not_empty.call(null,extmap__4236__auto__),null));
});
...
garden.types.CSSFunction.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k18682,else__4206__auto__){
var self__ = this;
var this__4205__auto____$1 = this;
var G__18687 = k18682;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k18682,else__4206__auto__);
...
garden.types.CSSFunction.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__18681){
var self__ = this;
var G__18681__$1 = this;
return (new cljs.core.RecordIter((0),G__18681__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"args","args",1315556576)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
garden.types.CSSFunction.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this18683,other18684){
var self__ = this;
var this18683__$1 = this;
return ((!((other18684 == null))) && ((this18683__$1.constructor === other18684.constructor)) && (cljs.core._EQ_.call(null,this18683__$1.f,other18684.f)) && (cljs.core._EQ_.call(null,this18683__$1.args,other18684.args)) && (cljs.core._EQ_.call(null,this18683__$1.__extmap,other18684.__extmap)));
});
...
garden.types.CSSFunction.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__18681){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__18689 = cljs.core.keyword_identical_QMARK_;
var expr__18690 = k__4211__auto__;
if(cljs.core.truth_(pred__18689.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),expr__18690))){
return (new garden.types.CSSFunction(G__18681,self__.args,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__18689.call(null,new cljs.core.Keyword(null,"args","args",1315556576),expr__18690))){
return (new garden.types.CSSFunction(self__.f,G__18681,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSFunction(self__.f,self__.args,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4211__auto__,G__18681),null));
}
}
});
...
garden.types.CSSFunction.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__18681){
var self__ = this;
var this__4202__auto____$1 = this;
return (new garden.types.CSSFunction(self__.f,self__.args,G__18681,self__.__extmap,self__.__hash));
});
 ...
 */
garden.types.map__GT_CSSFunction = (function garden$types$map__GT_CSSFunction(G__18686){
var extmap__4236__auto__ = (function (){var G__18692 = cljs.core.dissoc.call(null,G__18686,new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"args","args",1315556576));
if(cljs.core.record_QMARK_.call(null,G__18686)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__18692);
} else {
return G__18692;
}
})();
return (new garden.types.CSSFunction(new cljs.core.Keyword(null,"f","f",-1597136552).cljs$core$IFn$_invoke$arity$1(G__18686),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(G__18686),null,cljs.core.not_empty.call(null,extmap__4236__auto__),null));
});
...
garden.types.CSSAtRule.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k18699,else__4206__auto__){
var self__ = this;
var this__4205__auto____$1 = this;
var G__18706 = k18699;
...
garden.types.CSSAtRule.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__18698){
var self__ = this;
var G__18698__$1 = this;
return (new cljs.core.RecordIter((0),G__18698__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
garden.types.CSSAtRule.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this18700,other18701){
var self__ = this;
var this18700__$1 = this;
return ((!((other18701 == null))) && ((this18700__$1.constructor === other18701.constructor)) && (cljs.core._EQ_.call(null,this18700__$1.identifier,other18701.identifier)) && (cljs.core._EQ_.call(null,this18700__$1.value,other18701.value)) && (cljs.core._EQ_.call(null,this18700__$1.__extmap,other18701.__extmap)));
});
...
garden.types.CSSAtRule.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__18698){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__18721 = cljs.core.keyword_identical_QMARK_;
var expr__18722 = k__4211__auto__;
if(cljs.core.truth_(pred__18721.call(null,new cljs.core.Keyword(null,"identifier","identifier",-805503498),expr__18722))){
return (new garden.types.CSSAtRule(G__18698,self__.value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__18721.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__18722))){
return (new garden.types.CSSAtRule(self__.identifier,G__18698,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSAtRule(self__.identifier,self__.value,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4211__auto__,G__18698),null));
}
}
});
...
garden.types.CSSAtRule.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__18698){
var self__ = this;
var this__4202__auto____$1 = this;
return (new garden.types.CSSAtRule(self__.identifier,self__.value,G__18698,self__.__extmap,self__.__hash));
});
 ...
 */
garden.types.map__GT_CSSAtRule = (function garden$types$map__GT_CSSAtRule(G__18702){
var extmap__4236__auto__ = (function (){var G__18729 = cljs.core.dissoc.call(null,G__18702,new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217));
...
return (new garden.types.CSSAtRule(new cljs.core.Keyword(null,"identifier","identifier",-805503498).cljs$core$IFn$_invoke$arity$1(G__18702),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__18702),null,cljs.core.not_empty.call(null,extmap__4236__auto__),null));
});


//# sourceMappingURL=types.js.map?rel=1541436683386
