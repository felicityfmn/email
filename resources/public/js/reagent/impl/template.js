...
var temp__5637__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
...
var k_SINGLEQUOTE_ = temp__5637__auto__;
...
var G__18474 = o;
(G__18474[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__18476__i < G__18476__a.length) {G__18476__a[G__18476__i] = arguments[G__18476__i + 0]; ++G__18476__i;}
  args = new cljs.core.IndexedSeq(G__18476__a,0,null);
} 
...
if(reagent.impl.template.named_QMARK_.call(null,k)){
var temp__5637__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.custom_prop_name_cache,cljs.core.name.call(null,k));
if((temp__5637__auto__ == null)){
...
var G__18478 = o;
(G__18478[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__18480__i < G__18480__a.length) {G__18480__a[G__18480__i] = arguments[G__18480__i + 0]; ++G__18480__i;}
  args = new cljs.core.IndexedSeq(G__18480__a,0,null);
} 
...
var G__18483 = props;
var G__18483__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__18483,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__18483);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__18483__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__18484){
...
var props = map__18485__$1;
var class$ = cljs.core.get.call(null,map__18485__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__18485,map__18485__$1,props,class$){
return (function (c){
...
});})(map__18485,map__18485__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__18487){
var map__18488 = p__18487;
var map__18488__$1 = ((((!((map__18488 == null)))?(((((map__18488.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18488.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18488):map__18488);
var on_write = cljs.core.get.call(null,map__18488__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__18488,map__18488__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__18488,map__18488__$1,on_write))
);
} else {
...
var G__18491 = jsprops;
(G__18491["defaultValue"] = value);

(G__18491["onChange"] = ((function (G__18491,v,value,on_change){
return (function (p1__18490_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__18490_SHARP_);
});})(G__18491,v,value,on_change))
);
...
var vec__18494 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__18494,(0),null);
var id = cljs.core.nth.call(null,vec__18494,(1),null);
var class$ = cljs.core.nth.call(null,vec__18494,(2),null);
...
var temp__5637__auto__ = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
if((temp__5637__auto__ == null)){
return reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null));
} else {
var k = temp__5637__auto__;
return k;
}
});
...
var jsprops = ({"argv": v});
var temp__5639__auto___18498 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5639__auto___18498 == null)){
} else {
var key_18499 = temp__5639__auto___18498;
(jsprops["key"] = key_18499);
}
...
var temp__5639__auto___18500 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5639__auto___18500 == null)){
} else {
var key_18501 = temp__5639__auto___18500;
reagent.impl.template.oset.call(null,jsprops,"key",key_18501);
}
...
var G__18502 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__18502["name"] = c);
...
var temp__5637__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.tag_name_cache,x);
if((temp__5637__auto__ == null)){
return (reagent.impl.template.tag_name_cache[x] = reagent.impl.template.parse_tag.call(null,x));
} else {
var s = temp__5637__auto__;
return s;
}
});
...
var len__4531__auto___18507 = arguments.length;
var i__4532__auto___18508 = (0);
while(true){
if((i__4532__auto___18508 < len__4531__auto___18507)){
args__4534__auto__.push((arguments[i__4532__auto___18508]));

var G__18509 = (i__4532__auto___18508 + (1));
i__4532__auto___18508 = G__18509;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq18505){
var G__18506 = cljs.core.first.call(null,seq18505);
var seq18505__$1 = cljs.core.next.call(null,seq18505);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18506,seq18505__$1);
});
...
break;
default:
var G__18512 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__18512;
continue;
...
var n__4408__auto___18514 = a.length;
var i_18515 = (0);
while(true){
if((i_18515 < n__4408__auto___18514)){
(a[i_18515] = reagent.impl.template.as_element.call(null,(a[i_18515])));
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___18517 = a.length;
var i_18518 = (0);
while(true){
if((i_18518 < n__4408__auto___18517)){
var val_18519 = (a[i_18518]);
if(((cljs.core.vector_QMARK_.call(null,val_18519)) && ((reagent.impl.template.key_from_vec.call(null,val_18519) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_18518] = reagent.impl.template.as_element.call(null,val_18519));

var G__18520 = (i_18518 + (1));
i_18518 = G__18520;
continue;
} else {
}
...
var ctx = ({});
var vec__18521 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__18521,(0),null);
var derefed = cljs.core.nth.call(null,vec__18521,(1),null);
...
var G__18524 = (cljs.core.count.call(null,argv) - first_child);
switch (G__18524) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__18524){
...
//# sourceMappingURL=template.js.map?rel=1541436518627
