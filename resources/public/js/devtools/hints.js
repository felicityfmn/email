...
var temp__5633__auto__ = cljs.core.deref.call(null,devtools.hints.processed_errors);
if(cljs.core.truth_(temp__5633__auto__)){
var val = temp__5633__auto__;
return val;
} else {
...
var file = cljs.core.get.call(null,map__9994__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__9994__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__9994__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e9993){var _e = e9993;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5633__auto___9999 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5633__auto___9999)){
var seen_errors_10000 = temp__5633__auto___9999;
if(cljs.core.truth_(seen_errors_10000.has(self))){
} else {
seen_errors_10000.add(self);

var temp__5635__auto___10001 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5635__auto___10001)){
var sense_10002 = temp__5635__auto___10001;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_10002)].join('');
} else {
}
}
} else {
...
var temp__5635__auto__ = devtools.hints.error_object_sense.call(null,error);
if(cljs.core.truth_(temp__5635__auto__)){
var sense = temp__5635__auto__;
...
//# sourceMappingURL=hints.js.map?rel=1541436387531
